...
async function open_exposure_pnl(){
    ...
    var pnl_t1 = await fetch("https://dev101.info/dashboard/Risk/api.php?open_pnl_exposure=1",{
        method: 'GET'
    });
    var pnl_t1_data = await pnl_t1.json();

    var pnl_current = await fetch("https://dev101.info/dashboard/Risk/api.php?open_pnl_exposure=2",{
        method: 'GET'
    });
...
function account_stats(option){
    $.get("https://dev101.info/dashboard/Risk/api.php?account_type=1", (data, status) => {
...
function symbol_exposure(){
    $.get("https://dev101.info/dashboard/Risk/api.php?symbol_exposure=1", (data, status) => {
        // Clean out table
...
function top_10_pnl(option){
    $.get(`https://dev101.info/dashboard/Risk/api.php?top_10_pnl=${option}`, (data, status) => {
...
function bottom_10_pnl(option){
    $.get(`https://dev101.info/dashboard/Risk/api.php?bottom_10_pnl=${option}`, (data, status) => {
...
function suspicious_accounts(){
    $.get(`https://dev101.info/dashboard/Risk/api.php?suspicious_accounts=1`, (data, status) => {
...
function top_10_client_exposure(){
    $.get(`https://dev101.info/dashboard/Risk/api.php?top_10_client_exposure=1`, (data, status) => {
...
function closed_trades_pnl(start,end){
    $.get(`https://dev101.info/dashboard/Risk/api.php?start_date=${start}&end_date=${end}`, (data, status) => {
...
// Enpoint 10
function aif_sync(){
    $.get(`https://dev101.info/dashboard/Risk/api.php?aif_sync=1`, (data, status) => {
...
// Endpoint 11
function fmt_sync(){
    $.get(`https://dev101.info/dashboard/Risk/api.php?fmt_sync=1`, (data, status) => {
